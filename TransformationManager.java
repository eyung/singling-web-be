...
public class TransformationManager {
    ...
    public static class Instruction implements Serializable {
        ...
        public enum Mods { WORDTYPE, WORDLENGTH, LGC, PUNCTUATION, SYMBOL, CHARACTER, SENTIMENT }

        public enum SoundMods { TEMPO, NOTE_DURATION, OCTAVE, INSTRUMENT, VOLUME, PERCUSSION, MIDI_NOTE, ATTACK, DECAY, MAJOR, MINOR, PITCHBEND, PAN }

        public enum ModOperators { EQUALTO, LARGERTHAN, LESSTHAN }

        public enum ChangeModes { SET, INCREMENT }

        public enum SentimentTypes { POSITIVESENTIMENT, NEGATIVESENTIMENT }

        public enum InstructionStatus { ACTIVE, INACTIVE }
        ...
        public String toString() {
            if (mod.equals(Mods.WORDLENGTH)) {
                ...
                return mod +
                        ...
                        //":" + InstructionFormModels.LGClist[Integer.parseInt(modValue)] +
                        " TO " + changeMode +
                        " " + soundMod +
                        " " + soundModValue;
